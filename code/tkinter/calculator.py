...
button_equal = Button(root, text="=", padx=98, pady=20, command=btn_equal)
button_clear = Button(root, text="Clear", padx=88, pady=20, command=btn_clear)

button_subtract = Button(root, text="-", padx=39, pady=20, command=btn_sub)
button_multiple = Button(root, text="*", padx=40, pady=20, command=btn_mult)
button_divide = Button(root, text="/", padx=40, pady=20, command=btn_div)
